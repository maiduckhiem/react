        ...
        return (
            <div className="Footer">
                <footer className=" bg-black">
                    <div className="p-10 footer mt-10 container mx-auto text-base-content">
                        <div>
                ...
                <footer className="px-10 py-4 border-t footer bg-base-200 text-base-content border-base-300 container mx-auto">
